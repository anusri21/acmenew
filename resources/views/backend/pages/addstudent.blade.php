                           ...
                           <div class="col-md-6">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input type="text" name="dob" class="form-control accordion--form__text required" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask>
                                 </div>
                                 <!-- /.input group -->
                              </div>
                              <!-- /.form group -->
                           ...
                           <!-- Date mm/dd/yyyy -->
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" name="email" class="form-control accordion--form__text required"
                        ...
                        <div class="col-md-6">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input type="text" name="doj" class="form-control accordion--form__text required" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask>
                                 </div>
                                 <!-- /.input group -->
                              </div>
                              <!-- /.form group -->
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" name="admission_date" class="form-control accordion--form__text required" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask>
                                </div>
                                <!-- /.input group -->
                            </div>
                           <!-- /.form group -->
                     ...
                     <legend class="accordion--form__legend">Personal Details</legend>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="accordion--form__row">
                              <input class="accordion--form__submit" type="button" id="btnSubmit" name="submit" value="Submit">
                           </div>
                           <a class="accordion--form__prev-btn">Prev</a>
                        </div>
                     </fieldset>
