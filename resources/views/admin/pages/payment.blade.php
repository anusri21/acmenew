							...
							<div class="agileits_w3layouts_main_grid">
                                ...
                                {{ csrf_field() }}								<span>
									...
									<span>
										...
										<input name="payment_id" type="text" placeholder="payment Id" required="">
									</span>
									<span>
										<label>Payment Method</label>
										<input name="paymentmethod" type="text" placeholder="payment method" required="">
									</span>
									<span>
										<label>Payment Applied</label>
										<input name="paymentapplied" type="text" placeholder="payment applied" required="">
									</span>
									<span>
										<label>Date Recieved</label>
										<input name="datarecived" type="text" placeholder="date recieved" required="">
									</span>
									<span>
										<label>Payment Amount Currency</label>
										<input name="amount " type="text" placeholder="payment amount curency" required="">
									</span>
