...
<div class="col-lg-6">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        {{ csrf_field() }}
                        <input type="hidden" name="id" id="text-input" value="{{$enquiryrs->id}}" class="form-control">
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Name</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="name" id="text-input"  value="{{$enquiryrs->name}}" placeholder="Name" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="email-input" class=" form-control-label">Email </label></div>
                            <div class="col-12 col-md-9"><input type="email" id="email-input" name="email"  value="{{$enquiryrs->email}}"  placeholder="Enter Email" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="password-input" class=" form-control-label">Phone</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="password-input" name="phone"   value="{{$enquiryrs->phone}}" placeholder="Phone" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Alternate Phone</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="disabled-input" name="alternate_phone"  value="{{$enquiryrs->alternate_phone}}" placeholder="Alternate Phone"  class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="multiple-select" class=" form-control-label">Course</label></div>
                            <div class="col col-md-9">
                              <select name="course[]" id="multiple-select" multiple="" class="form-control"  value="{{$enquiryrs->course}}" >
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <select name="enquiry" id="select" class="form-control"  value="{{$enquiryrs->enquiry}}"onchange="Enquiry(this);"> 
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="password-input" name="doj"  value="{{$enquiryrs->doj}}"  placeholder="Joining Date" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Address</label></div>
                            <div class="col-12 col-md-9"><textarea name="address" id="textarea-input" rows="2" value="{{$enquiryrs->address}}"  placeholder="Address..." class="form-control"></textarea></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="select" class=" form-control-label">Reference By</label></div>
                            <div class="col-12 col-md-9">
                              <select name="reference" id="select" class="form-control"  value="{{$enquiryrs->reference}}" onchange="Reference(this);">
                                <option value="0">Please select</option>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><textarea name="comments"  value="{{$enquiryrs->comments}}"  id="textarea-input" rows="2" placeholder="Comments..." class="form-control"></textarea></div>
                          </div>
